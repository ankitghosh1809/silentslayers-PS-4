            ...
            <div className="flex-1 space-y-8 max-h-[calc(100vh-2rem)] overflow-y-auto pr-2 custom-scrollbar pb-20">
                            ...
                            <div className="glass p-10 rounded-[3rem] border-white/5 space-y-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="glass bg-white/5 p-8 rounded-[2.5rem] border-white/5 group hover:border-indigo-500/30 transition-all flex flex-col items-center text-center">
                                        ...
                                        <button className="w-full glass bg-purple-500/10 border-purple-500/20 py-3 rounded-xl text-[9px] font-black text-purple-400 uppercase tracking-widest hover:bg-purple-500/20 transition-all flex items-center justify-center gap-2">
                                    ...
                                    <div className="glass bg-white/5 p-8 rounded-[2.5rem] border-white/5 group hover:border-indigo-500/30 transition-all flex flex-col items-center text-center">
                                        ...
                                        <button className="w-full glass bg-emerald-500/10 border-emerald-500/20 py-3 rounded-xl text-[9px] font-black text-emerald-400 uppercase tracking-widest hover:bg-emerald-500/20 transition-all flex items-center justify-center gap-2">
                ...
                <div className="p-1 glass bg-white/5 rounded-[4rem] border-white/5 overflow-hidden">
                    <div className="glass p-16 rounded-[3.8rem] border-transparent relative overflow-hidden flex flex-col items-center">
                        ...
                        <div className="w-[200px] h-[200px] bg-white p-6 rounded-[2.5rem] shadow-2xl relative mb-10">
                        ...
                        <div className="flex gap-4">
                            <button className="glass bg-white text-slate-950 px-8 py-3 rounded-2xl text-[10px] font-black uppercase italic tracking-widest hover:scale-105 transition-all">
