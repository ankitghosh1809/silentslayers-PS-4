        ...
        <DashboardShell>
            <AnimatePresence>
                {showSummary && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-slate-950/80 backdrop-blur-sm"
                    >
                        <motion.div
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-0">
                <div>
                    ...
                    <h2 className="text-3xl md:text-5xl font-black italic tracking-tighter text-white uppercase italic leading-none">Executive Overview</h2>
                    <p className="text-muted-foreground text-sm font-medium italic mt-2">Real-time performance across 5 premium locations.</p>
                </div>
                <div className="flex flex-wrap gap-3 w-full sm:w-auto">
                    <button
                        onClick={() => setShowSummary(true)}
                        className="flex-1 sm:flex-none glass px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest text-white hover:bg-white/10 transition-all flex items-center justify-center gap-2"
                    >
                    ...
                    <button
                        ...
                        disabled={exporting}
                        className="flex-1 sm:flex-none bg-gradient-to-tr from-indigo-500 to-indigo-700 hover:from-indigo-400 hover:to-indigo-600 text-white px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all shadow-xl shadow-indigo-500/20 flex items-center justify-center gap-2"
                    >
            ...
            {/* Footer info */}
            <div className="py-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] font-black text-muted-foreground uppercase tracking-widest border-t border-white/5">
