...
import { X, CheckCircle, Rocket, BarChart } from "lucide-react";
            ...
            <div className="flex-1 space-y-8 max-h-[calc(100vh-2rem)] overflow-y-auto pr-2 custom-scrollbar pb-20">
                ...
                <div className="glass p-10 rounded-[3.5rem] border-white/5 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="text-[10px] font-black text-white uppercase italic tracking-widest px-8 py-4 glass bg-white/5 hover:bg-white/10 rounded-2xl border-white/5 transition-all"
                    >
                    ...
                    {showWizard && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                            ...
                            <motion.div
                                ...
                                className="relative w-full max-w-xl glass p-10 rounded-[4rem] border-white/10 shadow-2xl overflow-hidden"
                            >
                                <div className="absolute top-0 right-0 p-8">
                                    <button onClick={() => setShowWizard(false)} className="p-3 hover:bg-white/5 rounded-2xl transition-all">
                                ...
                                {wizardStep === 1 && (
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <h3 className="text-3xl font-black text-white italic uppercase tracking-tighter">What are we focusing on?</h3>
                                        </div>
                                        <div className="grid grid-cols-1 gap-4">
                                            {[
                                                ...
                                                <button key={opt} onClick={handleNext} className="glass bg-white/5 p-6 rounded-3xl border-white/5 hover:border-indigo-500/30 text-left group transition-all">
                                ...
                                {wizardStep === 2 && (
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <h3 className="text-3xl font-black text-white italic uppercase tracking-tighter">Target Result?</h3>
                                        </div>
                                        <div className="grid grid-cols-1 gap-4">
                                            {[
                                                "Increase rating",
                                ...
                                {wizardStep === 3 && (
                                    <div className="space-y-8">
                                        <div className="text-center py-10">
                                            <Sparkles className="w-16 h-16 text-indigo-400 mx-auto animate-pulse mb-6" />
                                            <h3 className="text-2xl font-black text-white italic uppercase tracking-tight">AI Generation in Progress</h3>
                                            <p className="text-xs text-muted-foreground mt-2 italic">Gemini is synthesizing market data and trends...</p>
                                        </div>
                                        <button
                                            onClick={generateCampaign}
                                            disabled={generating}
                                            className="w-full bg-indigo-600 py-4 rounded-2xl text-[10px] font-black text-white uppercase italic tracking-widest shadow-xl"
                                        >
                                ...
                                {wizardStep === 4 && campaignData && (
                                    <div className="space-y-8">
                                        <div>
                                            ...
                                            <h3 className="text-3xl font-black text-white italic uppercase tracking-tighter">{campaignData.title}</h3>
                                        </div>

                                        <div className="space-y-4">
                                            <div className="glass bg-white/5 p-6 rounded-3xl border-white/5">
                                        ...
                                        <button
                                            ...
                                            className="w-full bg-white text-slate-950 py-4 rounded-2xl text-[10px] font-black uppercase italic tracking-widest shadow-2xl flex items-center justify-center gap-2"
                                        >
