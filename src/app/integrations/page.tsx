                    ...
                    <div className="glass p-16 rounded-[3.8rem] border-transparent relative overflow-hidden">
                        ...
                        <div className="max-w-3xl">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button className="glass bg-white/5 border-white/10 px-10 py-4 rounded-2xl text-[10px] font-black text-white uppercase italic tracking-widest hover:bg-white/10 transition-all">
                                    Read API Docs
                                </button>
                            </div>
                        </div>
